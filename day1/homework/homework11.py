...
user_score =int(input("enter any number from 1 to 100: "))
if user_score > 90 !=101:
    print("Your grade is A")
elif user_score > 80 != 90:
    print("Your grade is B")
elif user_score > 70 != 80:
...
user_random_year =int(input("enter any year: "))